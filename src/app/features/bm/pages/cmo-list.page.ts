        ...
        <div class="card animate-fade-in-up">
          <div class="card__body" style="padding:0; overflow-x:auto;">
            @if (facade.cmoList().length === 0) {
              <div class="empty-state"><h3 class="empty-state__title">Tidak ada data CMO</h3></div>
            } @else {
                ...
                <tbody>
                  @for (cmo of facade.cmoList(); track cmo.cmo_id) {
                    <tr>
                      ...
                      <td><a [routerLink]="['/bm/cmo', cmo.cmo_id]" class="btn btn--primary btn--sm">Customers</a></td>
                    </tr>
                  }
                </tbody>
              </table>
