        ...
        <div class="card animate-fade-in-up">
          ...
          <div class="card__body" style="padding:0; overflow-x:auto;">
            @if (facade.flaggedCustomers().length === 0) {
              <div class="empty-state"><div class="empty-state__icon">✅</div><h3 class="empty-state__title">Tidak ada customer flagged</h3></div>
            } @else {
        ...
        <div class="card animate-fade-in-up" style="margin-top: 24px;">
          ...
          <div class="card__body" style="padding:0; overflow-x:auto;">
            @if (facade.googleFlagged().length === 0) {
              <div class="empty-state"><div class="empty-state__icon">✅</div><h3 class="empty-state__title">Tidak ada customer dengan bukti dari internet</h3></div>
            } @else {
              <table class="data-table">
